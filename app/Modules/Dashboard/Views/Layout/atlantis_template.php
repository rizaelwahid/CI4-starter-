...
<body onload="checkThemeColor()">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img">
													<img src="/assets/images/avatar/jm_denis.jpg" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img">
													<img src="/assets/images/avatar/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="/assets/images/avatar/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img">
													<img src="/assets/images/avatar/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								...
								<li>
									<div class="notif-center">
										...
										<a href="#">
											<div class="notif-img">
												<img src="/assets/images/avatar/profile2.jpg" alt="Img Profile">
											</div>
											<div class="notif-content">
												<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="/assets/images/avatar/<?= session()->avatar ?>" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="/assets/images/avatar/<?= session()->avatar ?>" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4><?= session()->name ?></h4>
		...
		<div class="sidebar sidebar-style-2">
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<?php $sideMenu = getSideMenu('Dashboard'); ?>
					<ul class="nav nav-primary">
						<?php foreach ($sideMenu['menuGrup'] as $mg) : ?>
							<?php if ($mg['title'] != '') : ?>
								<li class="nav-section">
									<span class="sidebar-mini-icon">
										<i class="fa fa-ellipsis-h"></i>
									</span>
									<h4 class="text-section"><?= $mg['title']; ?></h4>
								</li>
							<?php endif; ?>
							<?php foreach ($mg['menu'] as $m) : ?>
								<?php if (empty($m['menusub'])) : ?>
									<li class="nav-item">
								...
								<?php else : ?>
									<li class="nav-item">
										<a data-toggle="collapse" href="#nav<?= $m['menu_id']; ?>">
											<i class="<?= $m['icon']; ?>"></i>
											<p><?= $m['title']; ?></p>
											<span class="caret"></span>
										</a>
										<div class="collapse" id="nav<?= $m['menu_id']; ?>">
											<ul class="nav nav-collapse">
												<?php foreach ($m['menusub'] as $mb) : ?>
													<?php if (empty($mb['menusubsub'])) : ?>
														<li>
															<a href="<?= base_url($mb['url']); ?>">
																<span class="sub-item"><?= $mb['title']; ?></span>
															</a>
														</li>
													<?php else : ?>
														<li>
															<a data-toggle="collapse" href="#subnav<?= $mb['menu_id']; ?>">
																<span class="sub-item"><?= $mb['title']; ?></span>
																<span class="caret"></span>
															</a>
															<div class="collapse" id="subnav<?= $mb['menu_id']; ?>">
																<ul class="nav nav-collapse subnav">
																	<?php foreach ($mb['menusubsub'] as $mbb) : ?>
																		<li>
																			<a href="<?= $mbb['url']; ?>">
																				<span class="sub-item"><?= $mbb['title']; ?></span>
																			</a>
																		</li>
																	<?php endforeach; ?>
																</ul>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="page-header">
							<h4 class="text-white page-title"><?= $title; ?></h4>
							<?= getBreadcrump(); ?>
						</div>
						<div class="mt-4">
							<!-- flash data -->
							...
							<div class="card full-height">
								<div class="card-header">
									<div class="card-head-row card-tools-still-right">
										<h4 class="card-title"><?= $title; ?> Data</h4>
										<div class="card-tools">
											<button class="btn btn-icon btn-link btn-primary btn-xs btn-refresh-card"><span class="fa fa-sync-alt"></span></button>
											<button class="btn btn-icon btn-link btn-primary btn-xs"><span class="fa fa-question"></span></button>
										</div>
									</div>
								</div>
								<div class="card-body">
								...
								<div class="quick-scroll scrollbar-outer">
									<div class="quick-content contact-content">
										...
										<div class="avatar-group">
											<div class="avatar">
												<img src="/assets/images/avatar/jm_denis.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="/assets/images/avatar/chadengle.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="/assets/images/avatar/mlane.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
												<img src="/assets/images/avatar/talha.jpg" alt="..." class="avatar-img rounded-circle border border-white">
											</div>
											<div class="avatar">
	...
	<!-- jQuery Scrollbar -->
	<script src="/assets/layouts/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>
